          ...
          <div className="flex items-center gap-4">
            {rateLimit.remaining !== null && (
              <span
                ...
                title={`GitHub API rate limit: ${rateLimit.remaining} of ${rateLimit.total || '?'} requests remaining per hour${rateLimit.resetsAt ? `. Resets at ${new Date(rateLimit.resetsAt).toLocaleTimeString()}` : ''}`}
              >
